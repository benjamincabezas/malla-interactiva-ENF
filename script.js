const ramos = [
  ...
  { id: "cuidadosFam", nombre: "Cuidado Enfermero de la Persona y Familia", prereqs: ["cuidadosI"], semestre: 3 },
  ...
  { id: "infancia", nombre: "CE de la Infancia y Adolescencia", prereqs: ["cuidadosII"], semestre: 5 },
  ...
  // 7° semestre
  { id: "mental", nombre: "CE en Salud Mental", prereqs: ["cuidadosII"], semestre: 7 },
  { id: "investigacion7", nombre: "Investigación", prereqs: ["investigacion"], semestre: 7 },
  { id: "efg7", nombre: "Electivo de Formación General", prereqs: [], semestre: 7 },

  // 8° semestre
  { id: "informaticaII", nombre: "Informática en Salud II", prereqs: ["informaticaI"], semestre: 8 },
